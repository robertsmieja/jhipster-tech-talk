            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('entryTimestamp')}>
                    Entry Timestamp <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
              ...
              <tbody>
                {blogPostList.map((blogPost, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{blogPost.text}</td>
                    <td>
                      <TextFormat type="date" value={blogPost.entryTimestamp} format={APP_DATE_FORMAT} />
                    </td>
                    <td>{blogPost.user ? blogPost.user.login : ''}</td>
